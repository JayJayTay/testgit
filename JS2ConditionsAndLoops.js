...
if (studentGrade <= 6){
   console.log(studentClass = "Student will be in Elementary School");
   } else if (studentGrade == 7 || 8){
      console.log( studentClass = "Student will be in Middle School");
   } else if (studentGrade == 9){
      console.log(studentClass = "Student will be a Freshman");
   } else if (studentGrade === 10){
      console.log(studentClass = "Student will be a Sophomore");
   } else if (studentGrade === 11){
      console.log(studentClass = "Student will be a Junior");
   } else if (studentGrade === 12){
      console.log(studentClass = "Student will be a Senior");
   } else {
      console.log("Error");
}
